                    ...
                    <form method="POST" action="" class="col s12">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <input id="de" name="dataInicial" type="text" required class="validate datepicker">
                            </div>
                            <div class="input-field col s12 m6">
                                <i class="material-icons prefix">event_note</i>
                                <input id="ate" name="dataFinal" type="text" required class="validate datepicker">
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <?php
                        ...
                        foreach($vb as $agenda){
                            ...
                            <div class='col s12 m6 center'>
                             <img class='img' src='imgs/eventos/$imagem'>
                            </div> 
